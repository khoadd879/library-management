                        ...
                        {loading ? (
                            ...
                            loans.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-sm">
                                        {item.dateBorrow?.slice(0, 10)}
                                    </td>
                                    <td className="px-4 py-3 text-sm">
                                        {item.dateReturn?.slice(0, 10)}
                                    </td>
                                    <td className="px-4 py-3 text-sm">
                                        <button
                ...
                {selectedLoan && (
                    <div className="p-4 border border-[#e5e7eb] rounded-lg shadow-sm">
                        ...
                        <div className="flex items-start mb-6">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Mã sách: {selectedLoan.idBook}
                                </p>
                                <p className="text-sm text-gray-500">
                                    Tác giả:{' '}
                                    {authorNames[selectedLoan.idBook] ||
                                        'Đang tải...'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="mb-4">
                            ...
                            <p className="pl-6">
                                {user?.data.nameReader || 'Không xác định'}
                            </p>
                        </div>
                        {/* Thông tin mượn trả */}
                        <div>
