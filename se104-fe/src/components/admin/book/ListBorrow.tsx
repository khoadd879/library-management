...
const ListBorrow = () => {
        ...
        try {
            ...
            const mappedData: ILoanData[] = loans.map((item: any) => {
                ...
                return {
                    ...
                    readerName: reader
                        ? reader.nameReader
                        : item.idReader || 'Không rõ',
                    bookNameDisplay:
                        item.nameBook || book?.nameBook || '(Không rõ tên)',
                };
            });

            mappedData.sort(
                (a, b) =>
                    dayjs(b.borrowDate).valueOf() -
                    dayjs(a.borrowDate).valueOf(),
            );
    ...
    const columns: ColumnsType<ILoanData> = [
        ...
        },
        {
            ...
            sorter: (a, b) =>
                dayjs(a.borrowDate).valueOf() - dayjs(b.borrowDate).valueOf(),
            responsive: ['md'],
        },
        {
            title: 'Hạn trả',
    ...
    const filteredData = data.filter((item) => {
        ...
        return (
            rName.toLowerCase().includes(search) ||
                ...
                <div className="sm:p-2">
                    <div className="flex flex-col gap-3 sm:gap-4 mb-4 sm:mb-6">
                        ...
                        <div>
                            <Title
                                level={4}
                                className="!text-base sm:!text-xl !mb-0"
                                style={{ color: '#153D36' }}
                            >
                                Quản Lý Mượn Trả
                            </Title>
                            <p className="text-gray-500 text-xs sm:text-sm">
                                Theo dõi danh sách sách đang được mượn
                            </p>
                        </div>
                    ...
                    <div className="overflow-x-auto -mx-3 sm:mx-0">
                        <div className="min-w-[400px] sm:min-w-0 px-3 sm:px-0">
                            <Table
                                ...
                                locale={{
                                    emptyText: 'Không có dữ liệu mượn sách',
                                }}
                                bordered
                                size="small"
