      ...
      <div className="bg-gradient-to-r from-[#153D36] to-[#1E5D4A] px-6 py-4 shadow-lg">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-emerald-200 text-sm">ID: {receiverId}</p>
          </div>
        </div>
      </div>
        ...
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-400">
            <div className="w-20 h-20 rounded-full bg-emerald-100 flex items-center justify-center mb-4">
              <UserOutlined className="text-4xl text-emerald-500" />
            </div>
            <p className="text-lg font-medium text-gray-500">Chưa có tin nhắn</p>
            <p className="text-sm text-gray-400 mt-1">Gửi tin nhắn để bắt đầu cuộc trò chuyện</p>
          </div>
        ) : (
                      ...
                      >
                        ...
                        {!isSender && (
                          <div className="flex-shrink-0">
                            <div className="w-8 h-8 rounded-full overflow-hidden ring-2 ring-blue-200 bg-blue-100 flex items-center justify-center">
                              {avatarUrl ? (
                                <img
                                  src={avatarUrl}
                                  alt={receiveUserName}
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full px-5 py-3 pr-12 rounded-full bg-gray-100 border-2 border-transparent focus:border-emerald-400 focus:bg-white transition-all duration-200 outline-none text-sm"
                value={input}
